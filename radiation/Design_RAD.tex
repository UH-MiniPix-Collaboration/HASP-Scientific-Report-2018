...
All desired commands were successfully sent, received, and processed over the course of flight. Commands were confirmed through either 
...
status of the payload over the course of testing, integration, and flight. Figure \ref{fig:rtp} below are the four plots created by the 
real-time plotter.

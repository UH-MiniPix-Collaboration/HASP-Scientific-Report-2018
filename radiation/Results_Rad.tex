...
During the duration of the flight, a total of 16376 frames of data were collected and recovered successfully from the payload. Shown in Figure \ref{tracks} are a sample of some of the tracks collected at float. The image in the top left likely represents an interaction with a heavy ion while the rest of the tracks show some light and straight tracks.

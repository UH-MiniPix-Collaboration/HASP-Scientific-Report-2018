...
%
	\item Based on previous MiniPIX data, we can compare it to the current flight and observe a stark difference due to capture neutron events.
		\begin{enumerate}
			...
			\item Status: Although the data has been received, it is still under analysis.  The team is currently trying to better understand how the scintillator may have affected the flight, and the results are promising.  
		\end{enumerate}	

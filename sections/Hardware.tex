...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=100 mm, scale=1]{figures/payload_render.pdf}
...
The overall system organization was kept simple.  As shown in figure ~\ref{fig:payload_sec}, the payload carried a full load of scientific equipment.

\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=100 mm, scale=1]{figures/payload_sections.pdf}
